...
<aside id="sidebar-multi-level-sidebar" className="fixed top-0 left-0 z-40 w-64 items-center transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
